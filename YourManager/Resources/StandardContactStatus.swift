...
//        ]
    ...
    public var standardContactInfo = Contact(id: "", status: ContactStatus.booked, contactName: "Contact Name", contactPersonName: "Namn Namnsson", contactNotes: "kagkdffgafu huagfiavf vafivf hyva hyvfjavdavcjahcvjaf yvauvfuavcy  ycvahcviacv cyavcvaydfvdav yvauvcuaqvcwe.", phoneNumbers: ["012 345 67 89"], mailAdresses: ["mail@fakecontact.com"], postAdresses: ["Storagatan 33"], websites: ["business.com"])
    
    public var standardContactInfo2 = Contact(id: "", status: ContactStatus.closed, contactName: "Contact Name 2", contactPersonName: "Namn Namnsson", contactNotes: "kagkdffgafu huagfiavf vafivf hyva hyvfjavdavcjahcvjaf yvauvfuavcy  ycvahcviacv cyavcvaydfvdav yvauvcuaqvcwe.", phoneNumbers: ["012 345 67 89"], mailAdresses: ["mail@fakecontact.com"], postAdresses: ["Storagatan 33"], websites: ["business.com"])
}
